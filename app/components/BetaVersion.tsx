      ...
      >
        <div className="container mx-auto px-6 py-4 flex justify-between items-center">
          <div className="flex items-center">
            <Image src="/images/frogcraft-logo.png" alt="FrogCraft Logo" width={32} height={32} className="mr-3" />
      ...
      <footer className="w-full py-8 bg-gray-900 text-center text-gray-500">
        <div className="container mx-auto px-4">
          <div className="flex justify-center items-center mb-4">
            <Image src="/images/frogcraft-logo.png" alt="FrogCraft Logo" width={24} height={24} className="mr-2" />
            <span>FrogCraft</span>
          </div>
